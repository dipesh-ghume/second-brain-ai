...
export function Sidebar({ open, onClose, user }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed left-0 top-0 z-50 h-screen w-64 flex flex-col transition-transform lg:translate-x-0 ${
      ...
      >
        <div className="flex items-center gap-3 px-6 py-5 border-b border-white/10">
          ...
          <div>
            <h1 className="text-white font-bold text-lg leading-none">Second Brain</h1>
            <p className="text-xs mt-0.5" style={{ color: "var(--sidebar-text)" }}>AI Intelligence</p>
          </div>
        </div>
